...
public class ArrayLists03 {
    public static void main(String[] args) {
        ...
        //REMOVE() METHOD, NORMALLY WORKS IN LIST TO REMOVE AN ELEMENT, BUT IT DOES NOT USABLE IN THIS LIST,BEC THIS IS A FIXED IN LENGTH
        //LIST,NOT A REGULAR LIST.
        //IF A METHOD IS CHANGING THE SIZE, IT CANNOT BE USED "IN ASlIST" LIST


        //IF A METHOD IS CHANGING THE SIZE, IT CANNOT BE USED "IN ASlIST" LIST. like myList.add and myList.remove()
        //List is fixed in "size" in this situation,because Arrays in fixed in "length"
        //myList.add("Rambo");
        //System.out.println(myList);//UnsupportedOperationException
