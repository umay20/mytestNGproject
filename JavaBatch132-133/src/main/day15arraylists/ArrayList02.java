...
public class ArrayList02 {
    public static void main(String[] args) {
        ...
        //SET() METHOD,ORNEGIN 10000 TL ALTINDAKI OGRETMENLERIN SALARYLERINI SET YAPMAK ICIN KULLANILIR
       ...
       // System.out.println(myList);//[13, 77, 25, 77, 10]
        ...
        //Example 2: Create an integer list and remove the duplicated elements //yani how many different elements??
        //          [2,3,2,2,5]==>[2,3,5]



        List<Integer> yourList = new ArrayList<>(); //Java creates an empty list with the code.Java will check the elements one by one
        //if the element exist or not==>if it doesnt exist I will put it in the empty array.if it exist I will not put it in the new list
        yourList.add(2);
        yourList.add(3);
        yourList.add(2);
        yourList.add(2);
