...
public class Array01 {
     ...
     */
            ...
            ////Logic:I will go to first element and get the num of char in it 5 times.So this is repeated action and I will use for-loops
            ...
            for(int i=0; i<names.length; i++){  //burdaki length means;the length/ELEMENTS of the array.Thats why it =5.This doesnt get the char
                    //of the first element yet
                sum = sum + names[i].length();//burdaki length() counts the caracters of the first[0] element than increse
            }
