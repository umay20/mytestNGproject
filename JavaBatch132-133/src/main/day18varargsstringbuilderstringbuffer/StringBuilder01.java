...
public class StringBuilder01 {
 /*
    ...
    public static void main(String[] args) {
        ...
        //insert(4," is love"); will skip first 4 characters(not indexes,num of characters), then insert " is love"
        ...
        System.out.println(r);//2==> JAVA GIVES you the difference in alphabethical order(J and L arasinda 2 harf var,Lava
        // 2 after Java so it is positive 2(sb2 sb3 den sonra geliyorsa + once geliyorsa -, Java once Lava sonra olsaydi -2 veriyor)
