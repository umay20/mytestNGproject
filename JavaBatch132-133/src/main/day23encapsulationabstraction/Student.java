...
public class Student {
    ...
    public String stdName; //if you dont see access modi. it will be default,no need to name it but everyone can know and we made it public

    int stdGpa; ////if you make it default parents and teachers will know
