...
//        driver.findElement(By.xpath("//button[@data-qa='signup-button']")).click();
        ...
        sendKeysWithTimeout(waitForVisibility(By.xpath("//input[@data-qa='signup-email']"),3),"ghsa764a@gmail.com", 6);
...
//        mobile_number
        sendKeysWithTimeout(waitForVisibility(By.id("mobile_number"),3),"1234567890",6);
//      And click on Create Account. preferring JS click here..
        clickWithTimeoutByJS(waitForVisibility(By.xpath("//button[@data-qa='create-account']"),3));
        extentTest
                .pass("verify sign up is successful...")
                .addScreenCaptureFromPath(takeScreenshotOfTheEntirePageAsString());
//    Then verify the account creating is successful. Account Created! Element is displayed-HOMEWORK

        verifyElementDisplayed(By.xpath("//h2[@data-qa='account-created']//*[.='Account Created!']"));
        extentTest
                .pass("test is completed successfully")
                .addScreenCaptureFromPath(takeScreenshotOfTheEntirePageAsString());
        LoggerUtils.info("test case is complete ...");
    }
}